...
* 正式バージョンとなる1.0を公開しました（2026/06/25）
* リリースよりダウンロードしてください。
...
### Rのセットアップ
* 統計ソフトのRをダウンロードしてインストールしてください。
* 自動で連携するようになり、Rを使った分析が可能となります。
...
* 開発者は、本ソフトウェアの利用または利用不能に起因して生じたいかなる不利益・損害等についても、一切の責任を負いません。インストールおよび利用は、**利用者ご自身の責任**において行ってください。
...
## 更新履歴
* 2026.06.25　コードの軽量化を目的として機能別にコードを分割しました。統計ソフトRやAIとの連携を強化しました。これに伴い、正式バージョンとなる1.0として公開をしました。
